...
npm start               # 서버 가동 → http://13.209.81.179:8080
```
...
브라우저에서 `http://13.209.81.179:8080` 열고 `user_001` (또는 `user_002`)로 로그인. 비밀번호는 `.env`의 `DEMO_PASSWORD` 값(미설정 시 `demo1234`).
...
문서: `http://13.209.81.179:8080/api/docs` (Swagger UI)
